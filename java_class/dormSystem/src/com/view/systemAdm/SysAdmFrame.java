...
public class SysAdmFrame extends JFrame {
	...
	public SysAdmFrame(UserType usertype,SystemAdmin sysAdm) {
		...
		mnNewMenu_1.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
		...
		mntmNewMenuItem.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
		...
		mntmNewMenuItem_1.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
		mnNewMenu_1.add(mntmNewMenuItem_1);
		
		JMenu mnNewMenu_1_1 = new JMenu("\u5BBF\u820D\u697C\u7BA1\u7406");
		mnNewMenu_1_1.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
		...
		mntmNewMenuItem_2.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
		mnNewMenu_1_1.add(mntmNewMenuItem_2);
		
		JMenu mnNewMenu_1_2 = new JMenu("\u5BBF\u7BA1\u4FE1\u606F\u7BA1\u7406");
		mnNewMenu_1_2.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 19));
