...
public class AddBuildingFrame extends JFrame {
	...
	private static final String[] buildingType={"ƒ–«ﬁ","≈Æ«ﬁ"};
	...
	public AddBuildingFrame(BuildingFrame building) {
		...
		newBuildingName.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 20));
		...
		buildingTypeCombo.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 20));
		...
		remarksTextArea.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
