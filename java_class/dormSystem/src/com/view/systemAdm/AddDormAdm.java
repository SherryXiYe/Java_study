...
public class AddDormAdm extends JFrame {
	...
	public AddDormAdm(DormAdmManage dormA) {
		...
		userID.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
		userID.setColumns(10);
		userID.setBounds(199, 38, 130, 30);
		contentPane.add(userID);
		
		sex = new JComboBox();
		sex.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
		...
		password.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
		...
		buildingName.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
	...
	protected void insertDormAdm(ActionEvent e) {
		...
		if(is_empty(userID)||is_empty(sex)||is_empty(name)||is_empty(password)||is_empty(building)){
			JOptionPane.showMessageDialog(this, "«Î ‰»Î»´≤ø–≈œ¢");
		}else{
			...
			if(success){
				...
				JOptionPane.showMessageDialog(this, "≤Â»Î ß∞‹,«Î÷ÿ–¬ ‰»Î");
			}
			reset();
		}
	}
