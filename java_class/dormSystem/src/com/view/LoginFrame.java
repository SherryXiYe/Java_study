...
public class LoginFrame extends JFrame {
	...
	public LoginFrame() {
		...
		lblNewLabel.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 45));
		...
		lblNewLabel_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
		...
		lblNewLabel_1_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
		...
		lblNewLabel_1_2.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
		lblNewLabel_1_2.setBounds(96, 290, 165, 40);
		contentPane.add(lblNewLabel_1_2);
		
		userID = new JTextField();
		userID.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 26));
		userID.setBounds(275, 130, 240, 40);
		contentPane.add(userID);
		userID.setColumns(10);
		
		userPass = new JPasswordField();
		userPass.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
		userPass.setBounds(275, 212, 240, 40);
		contentPane.add(userPass);
		
		userTypeComb = new JComboBox();
		userTypeComb.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 26));
		...
		button.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
		...
		btnNewButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 28));
